package com.mrpark.dev.wooriportal.jobinfo.saramin.controller;

import com.mrpark.dev.wooriportal.jobinfo.saramin.dto.SearchRequestDto;
import com.mrpark.dev.wooriportal.jobinfo.saramin.dto.SearchResultDto;
import com.mrpark.dev.wooriportal.jobinfo.saramin.service.SaraminCrawlerService;
...
public class SaraminController {
    ...
    @GetMapping("/jobinfo/saramin")
    public String index() { return "jobinfo/saramin/index"; }

    @PostMapping("/jobinfo/saramin/api/search")
    @ResponseBody
    ...
    /** SSE 진행률 스트림 */
    @GetMapping(value = "/jobinfo/saramin/api/search-all/progress/{jobId}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    @ResponseBody
    ...
    /** 전체 수집 시작 → jobId 반환 */
    @PostMapping("/jobinfo/saramin/api/search-all")
    @ResponseBody
    ...
    /** 취소 */
    @DeleteMapping("/jobinfo/saramin/api/search-all/{jobId}")
    @ResponseBody
    ...
    @PostMapping("/jobinfo/saramin/api/build-url")
    @ResponseBody
