...
import com.park.welstory.wooriportal.common.common.CommonEntity;
import com.park.welstory.wooriportal.common.common.CommonRepository;
...
import com.park.welstory.wooriportal.board.facility.FacilityEntity;
import com.park.welstory.wooriportal.board.facility.FacilityRepository;
import com.park.welstory.wooriportal.board.management.ManagementEntity;
...
import com.park.welstory.wooriportal.board.personal.PersonalEntity;
import com.park.welstory.wooriportal.board.personal.PersonalRepository;
import com.park.welstory.wooriportal.board.sales.SalesEntity;
...
//                }
//                allList.sort(Comparator.comparing(BoardDTO::getCreatedAt).reversed());
//                int start = (int) pageable.getOffset();
//                int end = Math.min(start + pageable.getPageSize(), allList.size());
//                dto = new PageImpl<>(allList.subList(start, end), pageable, allList.size());
//            }
